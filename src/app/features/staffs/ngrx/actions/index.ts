...
export const uploadStaffViaExcel = createAction(
  '[StaffShellComponent] uploadStaffViaExcel',
  props<{ file: File }>()
);
export const updateStaffs = createAction(
  '[StaffShellComponent] updateStaffs',
  props<{ staff: any }>()
);
export const insertStaffs = createAction(
  '[StaffShellComponent] insertStaffs',
  props<{ staff: any }>()
);

export const uploadStaffViaExcelError = createAction(
  '[StaffShellComponent] error in upload students via excel',
  props<{ error: any }>()
);
...
export const doNothing = createAction('[StaffEffects] doNothing');
